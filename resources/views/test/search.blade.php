<x-master>
    ...
    @endif
    <div class="px-8 mx-auto grid grid-cols-4 gap-4">
        ...
        <x-card>
            ...
            <x-slot name="slot">
                <a href="#">
                    <img src="https://via.placeholder.com/300" alt="product" class=" block w-full h-[300px] rounded-xl p-2 object-cover border border-transparent hover:border-red-700">
                </a>
