                ...
                <div class="flex flex-col space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" id="title"
                            class="w-full rounded-lg p-2 border border-gray-300" value="{{ old('title') }}">
                        @error('title')
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" class="w-full rounded-lg p-2 border border-gray-300">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="number" name="price" id="price"
                            class="w-full rounded-lg p-2 border border-gray-300" value="{{ old('price') }}">
                        @error('price')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" id="stock"
                            class="w-full rounded-lg p-2 border border-gray-300" value="{{ old('stock') }}">
                        @error('stock')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        <img src="" class="w-[50%] mx-auto" id="imagePreview" >
                    ...
                    <div>
                        <button type="submit"
                            class="px-3 py-1 bg-green-400 hover:bg-green-500 rounded-xl text-white">Create Product
                        </button>
